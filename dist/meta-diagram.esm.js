...
const Sidebar = () => {
  ...
  return React__default.createElement(Box, {
    ...
    selected: true
  }, React__default.createElement(ListItemIcon, null, React__default.createElement("img", {
    src: `data:image/svg+xml;base64,${new Buffer(Cursor).toString('base64')}`,
    alt: "icon"
  }))), React__default.createElement(ListItemButton, null, React__default.createElement(ListItemIcon, null, React__default.createElement("img", {
...
class MetaGraph {
  ...
  getNodeContainerBoundingBox(node) {
  ...
  updateChildrenPosition(metaNodeModel) {
