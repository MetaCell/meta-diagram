...
import { List, Divider, ListItemButton, ListItemIcon, Box as Box$1 } from '@mui/material';
...
const Sidebar = () => {
  ...
  const SidebarItem = props => {
    ...
    return React__default.createElement(ListItemButton, {
      selected: selected === selection,
      onClick: () => setSelected(selection)
    }, React__default.createElement(ListItemIcon, null, selected === selection ? React__default.createElement("img", {
      src: svgImg(image),
      alt: name
