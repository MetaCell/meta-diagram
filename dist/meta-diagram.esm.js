...
class MetaNodeFactory extends AbstractReactFactory {
...
class MetaLinkFactory extends DefaultLinkFactory {
  constructor(componentsMap) {
...
const Sidebar = () => {
  ...
  }, React__default.createElement(ListItemIcon, null, selected === "1" ? React__default.createElement("img", {
  ...
  }, React__default.createElement(ListItemIcon, null, selected === "2" ? React__default.createElement("img", {
  ...
  }, React__default.createElement(Divider, null), React__default.createElement("img", {
    src: `data:image/svg+xml;base64,${new Buffer(Node).toString('base64')}`,
    alt: "node"
  }), React__default.createElement(Divider, null)), React__default.createElement(List, {
    disablePadding: true,
    component: "nav"
  }, React__default.createElement(ListItemButton, {
    selected: selected === "3",
    onClick: () => setSelected("3")
  }, React__default.createElement(ListItemIcon, null, selected === "3" ? React__default.createElement("img", {
  ...
  }, React__default.createElement(ListItemIcon, null, selected === "4" ? React__default.createElement("img", {
...
export { ComponentsMap, MetaLink, MetaLinkModel, MetaNode, MetaNodeModel, Position };
//# sourceMappingURL=meta-diagram.esm.js.map
